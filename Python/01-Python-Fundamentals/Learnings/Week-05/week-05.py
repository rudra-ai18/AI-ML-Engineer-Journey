...
# 11. Add an item to a list using append().

# item = ["Orange","Apple","Banana",]
# print(item.append("Coconut"))
# print(item)

# 12. Insert an item at a specific index.

nim = [1,2,3,4,67]
print(nim.insert(4,5))
print(nim)


# 13. Create a tuple containing 5 numbers.

lis = (21,321.22,22,33,33)
print(lis)

# 14.2. Create a tuple containing your name, age and course.

sub = ("name","age","course")
print(sub)

# 15. Print the first element  and  Print the last element

name = ("Rudra","Mudit","Himanshu")
print(name[0])
print(name[1])
